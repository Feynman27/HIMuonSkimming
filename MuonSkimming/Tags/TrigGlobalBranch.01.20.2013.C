...
#ifndef __CINT__
const int TrigGlobalBranch::N_EF_TRIGS_pPb = 25;
#endif
...
const std::string TrigGlobalBranch::L1_Trig_TBP_Names_pPb[15]={"L1_MU0"   , 	// 1    89
	...
	const unsigned int TrigGlobalBranch::EF_Trigs_id_pPb[25]={812,757,815,700,761,701,286,762,801,759,837,760,802,758,956,955,811,937,300,999,5114,318,1609,4179,4176};  
#endif
#ifndef __CINT__
	int TrigGlobalBranch::EF_Trigs[36] = {0};
#endif
#ifndef __CINT__
	int TrigGlobalBranch::EF_Trigs_pPb[25] = {0};
#endif
#ifndef __CINT__
...
#endif
#ifndef __CINT__
	const std::string TrigGlobalBranch::EF_Trig_Names_pPb[25]={
