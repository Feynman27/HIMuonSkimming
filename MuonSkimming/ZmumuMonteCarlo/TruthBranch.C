...
int TruthBranch::countTruth(int pdg){
	...
	for(int i = 0; i<mc_n; ++i){
	  ...
	  if((fabs(mc_gen_mothertype->at(i))==23||fabs(mc_gen_mothertype->at(i))==22)&&fabs(mc_gen_type->at(i))==pdg){
...
void TruthBranch::Fill_Truth_Branches(){
	...
	for(int i = 0; i<mc_n; ++i){
	  ...
	  //store only Z/DY di leptons
	  if((fabs(mc_gen_mothertype->at(i))==23||fabs(mc_gen_mothertype->at(i))==22)&&fabs(mc_gen_type->at(i))==13){
		//std::cout << "mc_gen_mothertype : " << mc_gen_mothertype->at(i) << std::endl;
		...
		for(int j = 0; j<mc_n; ++j){
	  		...
	  		if((fabs(mc_gen_mothertype->at(i))==23||fabs(mc_gen_mothertype->at(i))==22)&&fabs(mc_gen_type->at(j))==14){
	 ...
	 if(fabs(mc_gen_mothertype->at(i))==23&&fabs(mc_gen_type->at(i))==22){
