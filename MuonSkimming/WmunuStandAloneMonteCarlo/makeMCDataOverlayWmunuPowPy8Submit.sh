...
runname()
{
 ...
 FileName=$2
  ...
  elif [ $RUNNUMBER -eq 119986 ]; then
    File="mc11_2TeV.119986.PythiaWmunu_1Lepton_ppBeam_276TeV.recon.NTUP_HI.e1365_s1310_s1300_r4060/"
  fi
...
today=`date +%Y.%m.%d.`
prefix="user.tbalestr.NTUP_HI.PythiaWmunu.StandAlone."
...
do
  ...
  echo "    --athenaTag 19.2.0 \\">>$Filename
