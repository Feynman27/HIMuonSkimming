//
// File generated by rootcint at Thu Feb 26 02:51:17 2015
...
namespace ROOT {
   namespace Shadow {
      ...
      class MuonBranch  :  public ::BranchBase {
         ...
         double mu_muid_invMassOS[900]; //
         double mu_muid_invMassSS[900]; //
         int mu_muid_IDTP[30]; //
...
namespace ROOT {
   void MuonBranch_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*hConeTrkMuon", &sobj->hConeTrkMuon);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Mymu_muid_n", &sobj->Mymu_muid_n);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mu_muid_npairs", &sobj->mu_muid_npairs);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mu_muid_invMassOS[900]", sobj->mu_muid_invMassOS);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mu_muid_invMassSS[900]", sobj->mu_muid_invMassSS);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mu_muid_IDTP[30]", sobj->mu_muid_IDTP);
...
{
      G__letdouble(result7, 100, (double) ((MuonBranch*) G__getstructoffset())->getInvMass((int) G__int(libp->para[0]), (int) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letint(result7, 103, (long) ((MuonBranch*) G__getstructoffset())->recoMSTP((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dict_633_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((MuonBranch*) G__getstructoffset())->recoIDTP((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memvarMuonBranch(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__DictLN_TH1F),-1,-1,4,"hConeTrkMuon=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"Mymu_muid_n=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"mu_muid_npairs=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"mu_muid_invMassOS[900]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"mu_muid_invMassSS[900]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"mu_muid_IDTP[30]=",0,(char*)NULL);
...
static void G__setup_memfuncMuonBranch(void) {
   ...
   G__memfunc_setup("SelectMuon",1023,G__Dict_633_0_4, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getInvMass",1025,G__Dict_633_0_5, 100, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - imu1 i - - 0 - imu2", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("lv",226,G__Dict_633_0_6, 117, G__get_linked_tagnum(&G__DictLN_TLorentzVector), -1, 0, 3, 1, 1, 0, 
"f - - 0 - pt f - - 0 - eta "
"f - - 0 - phi", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("recoMSTP",749,G__Dict_633_0_7, 103, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - itag", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("recoIDTP",730,G__Dict_633_0_8, 103, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - itag", (char*)NULL, (void*) NULL, 0);
