  ...
  ntupleToRead->SetBranchAddress("mu_muid_z0_exPV",&mu_muid_z0_exPV);
  ntupleToRead->SetBranchAddress("mu_muid_isStandAloneMuon",&mu_muid_isStandAloneMuon);
  ntupleToRead->SetBranchAddress("mu_muid_ms_d0",&mu_muid_ms_d0);
  ntupleToRead->SetBranchAddress("mu_muid_ms_z0",&mu_muid_ms_z0);
  ntupleToRead->SetBranchAddress("mu_muid_ms_qoverp",&mu_muid_ms_qoverp);
...
//  ntupleToRead->SetBranchAddress("mu_muid_id_qoverp",&mu_muid_id_qoverp);
  ...
  ntupleToRead->SetBranchAddress("caloMETPhi",&caloMETPhi);
  ntupleToRead->SetBranchAddress("caloMETEta",&caloMETEta);
  ntupleToRead->SetBranchAddress("vx_x",&vx_x);
  ntupleToRead->SetBranchAddress("vx_y",&vx_y);
  ntupleToRead->SetBranchAddress("vx_z",&vx_z);
...
//  ntupleToRead->SetBranchAddress("singlemuid_massCBOS",&singlemuid_massCBOS);
  ...
  ntupleToRead->SetBranchAddress("trig_EF_trigmuonef_track_n",&trig_EF_trigmuonef_track_n);
	...
	ntupleToRead->SetBranchAddress("mc_mu_gen_barcode",&mc_mu_gen_barcode);
//	ntupleToRead->SetBranchAddress("mc_mu_gen_motherbarcode",&mc_mu_gen_motherbarcode);
...
//  ntupleToRead->SetBranchStatus("mu_muid_id_theta",1);
  ...
  ntupleToRead->SetBranchStatus("vx_x",1);
  ntupleToRead->SetBranchStatus("vx_y",1);
  ntupleToRead->SetBranchStatus("vx_z",1);

  ntupleToRead->SetBranchStatus("caloMET",1);
  ntupleToRead->SetBranchStatus("caloMEx",1);
  ntupleToRead->SetBranchStatus("caloMEy",1);
  ntupleToRead->SetBranchStatus("caloMETPhi",1);
  ntupleToRead->SetBranchStatus("caloMETEta",1);
