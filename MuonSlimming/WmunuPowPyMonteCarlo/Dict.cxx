//
// File generated by rootcint at Sun May 18 23:25:01 2014
...
namespace ROOT {
   namespace Shadow {
      ...
      class MuonSlim  {
         ...
         int mc_mu_gen_barcode[30]; //
         int mc_mu_gen_motherBarcode[30]; //
         int mc_nu_n; //
         ...
         int Mymc_mu_gen_motherBarcode[30]; //
         int Mymc_mu_gen_barcode[30]; //
         ...
         float eta_tru[30]; //
         float phi_tru[30]; //
         float truthdR_muid[30]; //
         int truthMatched_muid[30]; //
         int motherBarcode_muid_tru[30]; //
         int barcode_muid_tru[30]; //
         float mu_muid_pt[30]; //
         ...
         int EF_trigmuonef_EF_mu4_L1VTE50_Matched20[30]; //
         int EF_trigmuonef_EF_mu4_MSonly_L1TE50_Matched20[30]; //
         int L1Matched[30]; //
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MuonSlim*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MuonSlim", "./MuonSlim.h", 30,
...
namespace ROOT {
   void MuonSlim_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mc_mu_gen_barcode[30]", sobj->mc_mu_gen_barcode);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mc_mu_gen_motherBarcode[30]", sobj->mc_mu_gen_motherBarcode);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Mymc_mu_gen_motherBarcode[30]", sobj->Mymc_mu_gen_motherBarcode);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Mymc_mu_gen_barcode[30]", sobj->Mymc_mu_gen_barcode);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "truthdR_muid[30]", sobj->truthdR_muid);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "truthMatched_muid[30]", sobj->truthMatched_muid);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "motherBarcode_muid_tru[30]", sobj->motherBarcode_muid_tru);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "barcode_muid_tru[30]", sobj->barcode_muid_tru);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "caloMETEta", &sobj->caloMETEta);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "caloMETEtaNt", &sobj->caloMETEtaNt);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "EF_trigmuonef_EF_mu4_L1VTE50_Matched20[30]", sobj->EF_trigmuonef_EF_mu4_L1VTE50_Matched20);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "EF_trigmuonef_EF_mu4_MSonly_L1TE50_Matched20[30]", sobj->EF_trigmuonef_EF_mu4_MSonly_L1TE50_Matched20);
...
{
      G__letint(result7, 105, (long) ((MuonSlim*) G__getstructoffset())->assignPrompt((int) G__int(libp->para[0]), (int) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letint(result7, 105, (long) ((MuonSlim*) G__getstructoffset())->HICombinedMuonSelector((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 102, (double) ((MuonSlim*) G__getstructoffset())->AssignCentrality((float) G__double(libp->para[0]), (bool) G__int(libp->para[1])
...
static int G__Dict_651_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TLorentzVector* pobj;
         TLorentzVector xobj = ((MuonSlim*) G__getstructoffset())->WbosonFourVector((int) G__int(libp->para[0]));
...
static void G__setup_memvarMuonSlim(void) {
   ...
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"mc_mu_gen_barcode[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"mc_mu_gen_motherBarcode[30]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"Mymc_mu_gen_motherBarcode[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"Mymc_mu_gen_barcode[30]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,102,0,0,-1,-1,-1,4,"truthdR_muid[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"truthMatched_muid[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"motherBarcode_muid_tru[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"barcode_muid_tru[30]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,102,0,0,-1,-1,-1,4,"caloMETPhi=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,-1,-1,4,"caloMETEta=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,102,0,0,-1,-1,-1,4,"caloMETEtaNt=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"EF_trigmuonef_EF_mu4_L1VTE50_Matched20[30]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"EF_trigmuonef_EF_mu4_MSonly_L1TE50_Matched20[30]=",0,(char*)NULL);
...
static void G__setup_memfuncMuonSlim(void) {
   ...
   G__memfunc_setup("SlimHISingleMuon",1575,G__Dict_651_0_1, 105, -1, -1, 0, 5, 1, 1, 0, 
"u 'TString' - 0 - inputFiles g - - 0 - doMSLOW "
"g - - 0 - doMSUP g - - 0 - doIDLOW "
"g - - 0 - doIDUP", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("assignPrompt",1287,G__Dict_651_0_2, 105, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - pdgIdMother i - - 0 - pdgId", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ppMuonSelector",1472,G__Dict_651_0_3, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HICombinedMuonSelector",2194,G__Dict_651_0_4, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HIStandAloneCombinedMuonSelector",3195,G__Dict_651_0_5, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MatchTrigger",1217,G__Dict_651_0_6, 105, -1, -1, 0, 3, 1, 1, 0, 
"i - - 0 - imu f - - 0 - dR "
"i - - 0 - triggerIndex", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBranches",1106,G__Dict_651_0_7, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getSubtractedMpt",1666,G__Dict_651_0_8, 102, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getScaledMpt",1213,G__Dict_651_0_9, 102, -1, -1, 0, 3, 1, 1, 0, 
"f - - 0 - subMPT f - - 0 - scalefactor "
"f - - 0 - ptmu", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("randomEventMPx",1432,G__Dict_651_0_10, 102, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - i U 'TFile' - 0 - fMB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("randomEventMPy",1433,G__Dict_651_0_11, 102, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - i U 'TFile' - 0 - fMB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("randomEventCentrality",2210,G__Dict_651_0_12, 102, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - i U 'TFile' - 0 - fMB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getMpxCorrection",1677,G__Dict_651_0_13, 102, -1, -1, 0, 1, 1, 1, 0, "f - - 0 - Centrality", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getMpyCorrection",1678,G__Dict_651_0_14, 102, -1, -1, 0, 1, 1, 1, 0, "f - - 0 - Centrality", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AssignCentrality",1668,G__Dict_651_0_15, 102, -1, -1, 0, 3, 1, 1, 0, 
"f - - 0 - fcal_Et g - - 0 - isHI "
"g - - 0 - isHIp", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("WbosonFourVector",1671,G__Dict_651_0_16, 117, G__get_linked_tagnum(&G__DictLN_TLorentzVector), -1, 0, 1, 1, 1, 0, "i - - 0 - igen", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getArgStr",915,G__Dict_651_0_17, 117, G__get_linked_tagnum(&G__DictLN_string), -1, 0, 1, 1, 1, 0, "u 'TString' - 0 - inputfiletxt", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getFileList",1116,G__Dict_651_0_18, 117, G__get_linked_tagnum(&G__DictLN_vectorlEstringcOallocatorlEstringgRsPgR), G__defined_typename("vector<std::string>"), 0, 1, 1, 1, 0, "u 'TString' - 0 - inputfiletxt", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("openFromFileList",1634,G__Dict_651_0_19, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'TString' - 0 - inputfiletxt U 'TChain' - 0 - chain", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MuonSlim",820,G__Dict_651_0_20, 105, G__get_linked_tagnum(&G__DictLN_MuonSlim), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("MuonSlim", 820, G__Dict_651_0_21, (int) ('i'), G__get_linked_tagnum(&G__DictLN_MuonSlim), -1, 0, 1, 1, 1, 0, "u 'MuonSlim' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~MuonSlim", 946, G__Dict_651_0_22, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__Dict_651_0_23, (int) ('u'), G__get_linked_tagnum(&G__DictLN_MuonSlim), -1, 1, 1, 1, 1, 0, "u 'MuonSlim' - 11 - -", (char*) NULL, (void*) NULL, 0);
