...
#cmt_local_tagfile_checkreq = $(MuonMomentumCorrections_tag)_checkreq.make
cmt_local_tagfile_checkreq = $(bin)$(MuonMomentumCorrections_tag)_checkreq.make
cmt_local_setup_checkreq = $(bin)setup_checkreq$$$$.make
cmt_final_setup_checkreq = $(bin)setup_checkreq.make
#cmt_final_setup_checkreq = $(bin)MuonMomentumCorrections_checkreqsetup.make
cmt_local_checkreq_makefile = $(bin)checkreq.make

checkreq_extratags = -tag_add=target_checkreq

#$(cmt_local_tagfile_checkreq) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_checkreq) ::
else
$(cmt_local_tagfile_checkreq) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_checkreq); then /bin/rm -f $(cmt_local_tagfile_checkreq); fi ; \
	  $(cmtexe) -tag=$(tags) $(checkreq_extratags) build tag_makefile >>$(cmt_local_tagfile_checkreq)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_checkreq)"; \
	  test ! -f $(cmt_local_setup_checkreq) || \rm -f $(cmt_local_setup_checkreq); \
	  trap '\rm -f $(cmt_local_setup_checkreq)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(checkreq_extratags) show setup >$(cmt_local_setup_checkreq) && \
	  if [ -f $(cmt_final_setup_checkreq) ] && \
	    \cmp -s $(cmt_final_setup_checkreq) $(cmt_local_setup_checkreq); then \
	    \rm $(cmt_local_setup_checkreq); else \
	    \mv -f $(cmt_local_setup_checkreq) $(cmt_final_setup_checkreq); fi

else

#cmt_local_tagfile_checkreq = $(MuonMomentumCorrections_tag).make
cmt_local_tagfile_checkreq = $(bin)$(MuonMomentumCorrections_tag).make
cmt_final_setup_checkreq = $(bin)setup.make
#cmt_final_setup_checkreq = $(bin)MuonMomentumCorrectionssetup.make
cmt_local_checkreq_makefile = $(bin)checkreq.make
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)checkreq
#
#$(cmt_local_checkreq_makefile) :: $(checkreq_dependencies) $(cmt_local_tagfile_checkreq) build_library_links dirs checkreqdirs
#else
#$(cmt_local_checkreq_makefile) :: $(checkreq_dependencies) $(cmt_local_tagfile_checkreq) build_library_links dirs
#endif
#else
#$(cmt_local_checkreq_makefile) :: $(cmt_local_tagfile_checkreq)
#endif
...
checkreqinstall :: $(checkreq_dependencies) $(cmt_local_checkreq_makefile)
	$(echo) "(constituents.make) Starting install checkreq"
	@-$(MAKE) -f $(cmt_local_checkreq_makefile) install
	$(echo) "(constituents.make) install checkreq done"
...
checkrequninstall : $(checkrequninstall_dependencies) ##$(cmt_local_checkreq_makefile)
	$(echo) "(constituents.make) Starting uninstall checkreq"
	@if test -f $(cmt_local_checkreq_makefile); then \
	  $(MAKE) -f $(cmt_local_checkreq_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_checkreq_makefile) uninstall
	$(echo) "(constituents.make) uninstall checkreq done"
