...
${CMTROOT}/mgr/cmt cleanup -sh -pack=MuonMomentumCorrections -version=MuonMomentumCorrections-00-05-03 -path=/afs/cern.ch/user/t/tbalestr/public/17.2.10.5/MuonSlimming/WmunuPowPyMonteCarlo  $* >${cmtMuonMomentumCorrectionstempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt cleanup -sh -pack=MuonMomentumCorrections -version=MuonMomentumCorrections-00-05-03 -path=/afs/cern.ch/user/t/tbalestr/public/17.2.10.5/MuonSlimming/WmunuPowPyMonteCarlo  $* >${cmtMuonMomentumCorrectionstempfile}"
  cmtcleanupstatus=2
