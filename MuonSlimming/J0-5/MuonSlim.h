...
class MuonSlim {
	...
	private:
		...
		int val[30], prompt[30], ntrt[30], run, event, EFtrig1,EFtrig2,EFtrig3 ,EFtrig4,EFtrig5,EFtrig_hip1,EFtrig_hip2,EFtrig_hip3,EFtrig_hip4,EFtrig_hip5,EFtrig_hipMB ;
